...
namespace Gestion_Soutenances.Controllers
{
    public class EtudiantsController : Controller
    {
        ...
        {
              return _context.Etudiant != null ? 
                          View(await _context.Etudiant.ToListAsync()) :
                          Problem("Entity set 'SoutenanceContext.Etudiant'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SoutenanceContext.Etudiant'  is null.");
            }
            var etudiant = await _context.Etudiant.FindAsync(id);
            if (etudiant != null)
            {
